...
const gameData = {
    ...
    'green-kun': {
        ...
        highlights: [
            {
                title: 'コイン取得時の演出',
                description: 'コインを取ったらそのまま消えるのではなく、<span class="text-red">取得後にエフェクトを再生する演出</span>を加えました。この工夫により、<span class="text-red">コインを取った瞬間の気持ち良さ</span>を生み出し、プレイヤーの達成感を高めています。'
            },
            {
                title: 'マルチプラットフォーム対応',
                description: 'PCだけでなく、より多くの人にプレイしてもらえるよう、<span class="text-red">ゲームパッドやスマートフォン操作にも対応</span>させました。入力系統を柔軟に設計することで、どんなデバイスでも快適に遊べる操作感を目指しました。'
            }
        ],
        challenges: [{
